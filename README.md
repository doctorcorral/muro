<table>
  <tr>
    <td rowspan="2" width="210" align="center" valign="middle">
      <a href="https://muro-lang.dev"><img src="assets/muro-logo.png" alt="Muro" width="180"></a>
    </td>
    <td valign="top">
      <h1>A spec never becomes evidence.<br>Evidence never becomes a run.</h1>
    </td>
  </tr>
  <tr>
    <td valign="bottom">
...
[muro on Hex](https://hex.pm/packages/muro) is published by the [murolang](https://hex.pm/users/murolang) organization. Current release: 0.2.1. Releases are listed in [CHANGELOG.md](CHANGELOG.md).
